...
answer: "Our primary objectives are to train and prepare young professionals in technical fields, ensuring they are equipped with modern tools and methodologies to excel in the job market. Additionally, we aim to expand our client base, build trust, and provide substantial benefits to our students through partnerships with foreign companies."
  },
  {
question: "What benefit does Dragons BootCamp look for when partnering with other companies?",
answer: "The benefits vary depending on the nature of the partner company. We seek to expand our client base, build trust, and maximize the benefits for our students by providing them with training, materials, opportunities for internships, and real-world projects."
  },
  {
...
answer: ""
  ...
  {
question: "What are the industry sectors for the companies that can partner with Dragons and be a good fit?",
answer: "Companies in any sector that requires software development, training materials, internship opportunities, or mentorship programs can partner with Dragons BootCamp."
  },
  {
  ...
  return (
    <div className="w-full grid place-items-center p-2 my-12">
      <div className="text-5xl md:text-7xl text-center max-w-4xl z-10 flex justify-center m-auto relative mb-3 text-gray-200 font-semibold">
        <h1>
      ...
      <div className="max-w-4xl">
        {FQA.map((item, index) => (
          <Disclosure key={index}>
            <Disclosure.Button className="bg-purple-900 text-white capitalize w-full py-2 px-4 border-t-[2px] border-t-[solid] border-t-purple-300 my-4 text-gray-100 rounded-[1rem] duration-[0.5s] hover:border-t-white hover:bg-purple-800 max-md:rounded-md transition-colors">
              {item.question}
            </Disclosure.Button>
            <Disclosure.Panel className="text-gray-400 mb-2 text-[.9rem] transition-opacity">
              {item.answer}
            </Disclosure.Panel>
          </Disclosure>
        ))}
      </div>
      <div className="absolute grid place-items-center m-2 bottom-0 cursor-pointer w-full">
        <a
          href="https://github.com/DragonsEG/DragonsWebsite_MembersSprints/tree/main/Sprint1/FQA"
          target="_blank"
          rel="noreferrer"
        >
