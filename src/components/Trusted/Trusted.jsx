...
export default function Trusted() {
  ...
  return (
    <>
      <div className="relative font-inter h-32  grid place-items-center antialiased">
      <div className={styles.sec3_main_container_title}>
        ...
        <main className="relative h-20 flex flex-col justify-center max-w-[1400px] overflow-hidden">
