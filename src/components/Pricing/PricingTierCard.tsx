...
const PricingTierCard: React.FC<PricingTierCardProps> = ({ tier, frequency }) => {
  const discountPrice = typeof tier.discountPrice === 'string' ? tier.discountPrice : tier.discountPrice[frequency];
  const price = typeof tier.price === 'string' ? tier.price : tier.price[frequency];
