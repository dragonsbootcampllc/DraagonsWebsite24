            ...
            <div className="container  max-w-[1100px] mx-auto grid grid-cols-1 md:grid-cols-2 lg:grid-cols-6 gap-y-4 md:gap-5">
                {cardsData.map(({ title, text, image }, index) => (
                    <div
                        ...
                        key={index}
                        className={` bg-purple-950 hover:scale-[1.03] cursor-pointer transition-all ${index <= 1 ? "col-span-2 lg:col-span-3" : "col-span-2"} overflow-hidden bg-purple-950 rounded-3xl h-[375px] text-left flex flex-col justify-between`}
                    >
