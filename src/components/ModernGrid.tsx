  ...
  return (
    ...
    >
      <div className="flex flex-col  h-full justify-items-center ">
        <h1 className="text-2xl m-0 p-0 text-white font-bold text-center">
          Top Talent of 2023
        </h1>
    ...
    >
      ...
      >
        ...
        <p className="text-xs text-neutral-500">
          i have been learning PHP for 2 years now and i am still not good at
          it.
        </p>
      </motion.div>
      <motion.div
      ...
      >
        <p className="text-xs text-neutral-500">your roadmap is : 1) ....</p>
...
const items = [
  {
    ...
    description: (
      <span className="text-sm">
        Join a diverse community of learners, mentors, and industry experts. Get
  ...
  },
  {
    ...
    description: (
      <span className="text-sm">
        compete with top talent in the Dragons Community. Stand out from the
        crowd and Get rewarded with cash prizes.
      </span>
    ),
    header: <SkeletonTwo />,
    className: "md:col-span-1",
  ...
  },
  {
    ...
    description: (
      <span className="text-sm">
        challenge yourself and Be part of the top 3% of talent . Get access to
  ...
  },
  {
    ...
    description: (
      <span className="text-sm">
        Get matched with the right job opportunities based on your skills and
        interests. Let AI do the work for you!
      </span>
    ),
    header: <SkeletonFour />,
