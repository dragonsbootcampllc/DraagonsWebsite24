...
const ButtonComponent: React.FC<ButtonComponentProps> = ({ CTAtext }) => {
  return (
    <button className='relative animate-shimmer bg-[linear-gradient(110deg,#7B1FA2,45%,#CE93D8,55%,#7B1FA2)] bg-[length:200%_100%] bg-purple-700 group cursor-pointer shadow-2xl rounded-full p-px text-white font-bold leading-6 inline-block w-full h-full'>
