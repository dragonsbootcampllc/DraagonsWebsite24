...
import logoImg from "@/../public/Identity/Images/2023/Group 976.png";
const YouTubeIcon = () => (
  <svg
...
const LINKS = [
  {
    ...
    links: [
      ...
      { url: "#", title: "Students activity", status: true },
  ...
  },
  {
    ...
    links: [
      ...
      { url: "/", title: "Students Use Cases", status: false },
  ...
  },
  {
    title: "Legal",
    links: [
      { url: "/website/privacy-policy", title: "Privacy Policy", status: false },
      {
        url: "/website/terms-and-conditions",
        title: "Terms and Conditions",
        status: true,
      },
      { url: "/website/cookie-policy", title: "Cookie Policy", status: false },
...
function Footer() {
  return (
    <footer className='bg-purple-800/20 rounded-t-[30px] overflow-hidden w-full relative'>
      ...
      <div className='mx-auto max-w-screen-xl space-y-8 px-4 py-16 sm:px-6 lg:space-y-16 lg:px-8'>
        <div className='grid grid-cols-1 relative w-full gap-8 lg:grid-cols-3'>
          <div className='relative w-full z-10'>
            ...
            Prepare for the future. Just say the magic word: ready for a sprint?
                        </p>
                      ...
                      <li key={index}>
                        {link.status && link.url ? (
                          ...
                          <>
                            ...
                            <span className='soon text-xs rounded-full bg-purple-800 mx-2 py-[2px] px-[4px]'>Soon</span>
                          </>
                        )}
                      </li>
                    ))}
        ...
        <p className='text-xs font-bold text-gray-50'>
          © {CurrentYear}.Dragons Bootcamp LLC. All rights reserved.
        </p>
      </div>
    </footer>
  );
