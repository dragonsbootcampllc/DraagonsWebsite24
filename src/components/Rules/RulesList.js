...
const RulesList = [
  {
    id: 1,
    title: "Fundamental Knowledge Required",
    description:
      "Basic programming knowledge is required to succeed in our program " +
      "and to be able to work with your team. ",
    icon: (
      <svg
  ...
  {
    id: 3,
    title: "Daily Email Check Required",
    description:
  ...
  {
    id: 5,
    title: "Teamwork is Essential to Success",
    description:
